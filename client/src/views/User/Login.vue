  ...
  <div class="window-height window-width row justify-center items-center login">
    <div class="col q-pa-lg">
      <div class="row justify-center">
        <q-card
          class="shadow-24 animated fadeIn login-card col-xs-10 col-md-3"
          :class="{ 'animated fadeOut': showLeaveAnimation }"
          style="animation-duration: 1s;"
        >
          <q-card-section class="bg-blue-grey-7">
          ...
          <q-card-section class="text-center q-pa-sm">
            <p class="text-grey-6 mouseHover" @click="forgotPasswordClicked">
...
.login {
  background: linear-gradient(#031629, rgb(204, 202, 202));
}
.login-card {
  // width: 300px;
